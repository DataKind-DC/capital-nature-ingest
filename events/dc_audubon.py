...
class EventbriteIngester:
    ...
    def __init__(self, org_id):
        ...
        self.field_handlers = {
            ...
            'ingested_by': {
                'keys': 
                    'https://github.com/DataKind-DC/capital-nature-ingest/tree/master/lambdas/dc_aududbon/lambda_function.py',
...
def main():
    dc_audubon_ingester = EventbriteIngester(10726377705)
    dc_audubon_ingester.scrape()
    event_output = []
    for e in dc_audubon_ingester.output_data.keys():
        data = dc_audubon_ingester.output_data[e]
